...
def gain_better(
    ...
    # calculate effective taxed odds
    won['B365W_taxed'] = won.B365W*(1-tax)
    
    # How much got back
    #cashback = won.B365W.sum()
    cashback = won.B365W_taxed.sum()
...
def gain_crossover(
    ...
    '''
    Gives back the avarage performace of betting. Staight betting on the 
        player with the WORSE elo-score AND the better Rank.
...
def gain_crossover2(
    ...
    '''
    Gives back the avarage performace of betting. Staight betting on the 
        player with the better elo-score AND the WORSE Rank.
